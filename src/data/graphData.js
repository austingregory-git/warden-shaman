const columnWidth = (window.innerWidth-(window.innerWidth/13))/13
const rowHeight = (window.innerHeight-(window.innerHeight/10))/10
const nodeRadius = 30
...
export const graphData = {
    nodes: [
        ...
        },
        {
            ...
            requirements: ["Requires Shaman", "Requires Active [Elemental Shield]"],
            currentPoints: 0,
            maxPoints: 1,
            tier: 8,
            status: 'unavailable',
        ...
        },
        {
            ...
            tier: 8,
            status: 'unavailable',
            description: "Transform into an Earth Ascendant for 15 seconds, immediately resetting the CD of [Boulder Toss], reducing the CD of [Boulder Toss] by 50%, empowering [Earthen Strike], gaining a stack of [Fulmination] every second, graning 9 stacks of [Earth Shield], and spawning an Earthquake at your location which lasts for the duration of [Ascendance]",
